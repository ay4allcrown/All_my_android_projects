...
public class MainActivity extends AppCompatActivity {
    ...
    public void printToLogs(View view) {
        ...
        Log.v("MainActivity.java", textView1.getText().toString());

        // Find second menu item TextView and print the text to the logs
        TextView textView2 = (TextView) findViewById(R.id.menu_item_2);
        Log.v("MainActivity.java", textView2.getText().toString());

        // Find third menu item TextView and print the text to the logs
        TextView textView3 = (TextView) findViewById(R.id.menu_item_3);
        Log.v("MainActivity.java", textView3.getText().toString());
