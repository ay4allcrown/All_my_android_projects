...
public class CannonView extends SurfaceView implements
    ...
    public static final double TARGET_MAX_SPPED_PERCENT = 6.0 / 4;
    ...
    public void newGame(){
        ...
        for (int n = 0; n < TARGET_PIECES; n++){
            double velocity = screenWidth * (random.nextDouble() *
                    (TARGET_MAX_SPPED_PERCENT - TARGET_MIN_SPEED_PERCENT) +
                ...
                new DialogFragment(){
                    ...
                    public Dialog onCreateDialog(Bundle savedInstanceState) {
                        ...
                        builder.setMessage(getResources().getString(
                                R.string.result_format, shotFired, totalElapsedTime));
